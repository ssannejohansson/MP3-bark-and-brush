...
- I had HTML comments in the beginning of every template, but was told to change them to {# ... #} in my mentoring session. 
However, the {# ... #} showed up in the browser, so I ended up removing all those comments. 