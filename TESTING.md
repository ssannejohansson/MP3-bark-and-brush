...
| Prevent Double Booking | Feature is expected to disable already booked time slots to prevent double booking | Logged in and booked an appointment |  Occupied time slots was grayed out and disabled | ![screenshot](documentation/defensive/disabled-times.png) |
